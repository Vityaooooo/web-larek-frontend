...
Является абстрактным классом и основой для создания моделей данных для работы приложения, реализует механизм инициализации данных наследника класса Model, реализует механизм уведомления всех подписчиков об изменении данных при помощи функции ```emitChanges```
